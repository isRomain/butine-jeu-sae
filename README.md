...
**Objectif**
Les joueurs s’affrontent pour maximiser à la fois :

leur déplacement sur le plateau, et

leur récolte de fleurs sur un plateau composé de plaines.
...
* **Mécaniques du jeu**
	...
	* **Calcul des points**
		...
		* **Score = ( Nombre de fleurs maximum d’une zone ) × (Nombre de zones occupées par l’abeille)**

		* Cela signifie :

			- On prend le nombre de fleurs maximum présent dans une zone du plateau,

			- On multiplie ce nombre par le nombre de zones différents que l’abeille a occupées durant la partie.
